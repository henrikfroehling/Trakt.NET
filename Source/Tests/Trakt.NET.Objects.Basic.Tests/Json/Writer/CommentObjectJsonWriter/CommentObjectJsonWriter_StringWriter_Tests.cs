namespace TraktNet.Objects.Basic.Tests.Json.Writer
{
    ...
    {
        [Fact]
        public void Test_CommentObjectJsonWriter_WriteObject_StringWriter_Exceptions()
        {
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Only_Id_Property()
        {
            ITraktComment traktComment = new TraktComment
            {
                Id = 76957U
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Only_ParentId_Property()
        {
            ITraktComment traktComment = new TraktComment
            {
                ParentId = 1234U
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Only_CreatedAt_Property()
        {
            ITraktComment traktComment = new TraktComment
            {
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Only_Spoiler_Property()
        {
            ITraktComment traktComment = new TraktComment
            {
                Spoiler = true
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Only_Review_Property()
        {
            ITraktComment traktComment = new TraktComment
            {
                Review = true
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Only_Replies_Property()
        {
            ITraktComment traktComment = new TraktComment
            {
                Replies = 1
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Only_Likes_Property()
        {
            ITraktComment traktComment = new TraktComment
            {
                Likes = 2
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Only_UserRating_Property()
        {
            ITraktComment traktComment = new TraktComment
            {
                UserRating = 7.3f
        ...
        [Fact]
        public async Task Test_CommentObjectJsonWriter_WriteObject_StringWriter_Complete()
        {
            ITraktComment traktComment = new TraktComment
            {
                Id = 76957U,

namespace TraktApiSharp.Tests.Experimental.Requests.Base.Post
{
    ...
    public class ATraktListPostRequestTests
    {
        ...
        [TestMethod, TestCategory("Requests"), TestCategory("Base"), TestCategory("Post")]
        public void TestATraktListPostRequestImplementsITraktListPostRequestInterface()
        {
            typeof(ATraktListPostRequest<int, float>).GetInterfaces().Should().Contain(typeof(ITraktListPostRequest<int, float>));
        }
    }
}

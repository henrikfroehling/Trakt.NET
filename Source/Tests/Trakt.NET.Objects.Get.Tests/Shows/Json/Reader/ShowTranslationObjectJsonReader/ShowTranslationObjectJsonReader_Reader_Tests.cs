namespace TraktNet.Objects.Get.Tests.Shows.Json.Reader
{
    ...
    public partial class ShowTranslationObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_ShowTranslationObjectJsonReader_ReadObject_From_JsonReader_Incomplete_5()
        {
            var traktJsonReader = new ShowTranslationObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ShowTranslationObjectJsonReader_ReadObject_From_JsonReader_Incomplete_6()
        {
            var traktJsonReader = new ShowTranslationObjectJsonReader();
        ...
        [Fact]
        public void Test_ShowTranslationObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new ShowTranslationObjectJsonReader();

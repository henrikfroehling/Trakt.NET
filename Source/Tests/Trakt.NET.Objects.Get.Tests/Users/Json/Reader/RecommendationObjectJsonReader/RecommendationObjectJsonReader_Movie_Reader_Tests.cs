namespace TraktNet.Objects.Get.Tests.Users.Json.Reader
{
    ...
    public partial class RecommendationObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_RecommendationObjectJsonReader_Movie_ReadObject_From_JsonReader_Incomplete_7()
        {
            var traktJsonReader = new RecommendationObjectJsonReader();

            using var reader = new StringReader(JSON_MOVIE_INCOMPLETE_7);
            using var jsonReader = new JsonTextReader(reader);
        ...
        [Fact]
        public async Task Test_RecommendationObjectJsonReader_Movie_ReadObject_From_JsonReader_Incomplete_8()
        {
            var traktJsonReader = new RecommendationObjectJsonReader();

            using var reader = new StringReader(JSON_MOVIE_INCOMPLETE_8);
            using var jsonReader = new JsonTextReader(reader);
        ...
        [Fact]
        public async Task Test_RecommendationObjectJsonReader_Movie_ReadObject_From_JsonReader_Incomplete_9()
        {
            var traktJsonReader = new RecommendationObjectJsonReader();

            using var reader = new StringReader(JSON_MOVIE_INCOMPLETE_9);
            using var jsonReader = new JsonTextReader(reader);
        ...
        [Fact]
        public async Task Test_RecommendationObjectJsonReader_Movie_ReadObject_From_JsonReader_Incomplete_10()
        {
            var traktJsonReader = new RecommendationObjectJsonReader();

            using var reader = new StringReader(JSON_MOVIE_INCOMPLETE_10);
            using var jsonReader = new JsonTextReader(reader);

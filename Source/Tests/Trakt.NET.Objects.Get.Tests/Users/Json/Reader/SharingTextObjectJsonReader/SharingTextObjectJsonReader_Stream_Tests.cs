namespace TraktNet.Objects.Get.Tests.Users.Json.Reader
{
    ...
    public partial class SharingTextObjectJsonReader_Tests
    {
        ...
        [Fact]
        public void Test_SharingTextObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var jsonReader = new SharingTextObjectJsonReader();
            Func<Task<ITraktSharingText>> userSharingText = () => jsonReader.ReadObjectAsync(default(Stream));

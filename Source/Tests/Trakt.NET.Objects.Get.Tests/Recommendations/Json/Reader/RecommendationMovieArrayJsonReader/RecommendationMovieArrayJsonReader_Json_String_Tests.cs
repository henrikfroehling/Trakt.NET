namespace TraktNet.Objects.Get.Tests.Recommendations.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Empty_Array()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();
            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = await jsonReader.ReadArrayAsync(JSON_EMPTY_ARRAY);
            traktRecommendationMovies.Should().NotBeNull().And.BeEmpty();
        }

        [Fact]
        public async Task Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Complete()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();

            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = await jsonReader.ReadArrayAsync(JSON_COMPLETE);
        ...
        [Fact]
        public async Task Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Incomplete_1()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();

            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = await jsonReader.ReadArrayAsync(JSON_INCOMPLETE_1);
            traktRecommendationMovies.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
        ...
        [Fact]
        public async Task Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Incomplete_2()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();

            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = await jsonReader.ReadArrayAsync(JSON_INCOMPLETE_2);
            traktRecommendationMovies.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
        ...
        [Fact]
        public async Task Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();

            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = await jsonReader.ReadArrayAsync(JSON_NOT_VALID_1);
            traktRecommendationMovies.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
        ...
        [Fact]
        public async Task Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();

            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = await jsonReader.ReadArrayAsync(JSON_NOT_VALID_2);
            traktRecommendationMovies.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
        ...
        [Fact]
        public async Task Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();

            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = await jsonReader.ReadArrayAsync(JSON_NOT_VALID_3);
            traktRecommendationMovies.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
        ...
        [Fact]
        public void Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Null()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();
            Func<Task<IEnumerable<ITraktRecommendationMovie>>> traktRecommendationMovies = () => jsonReader.ReadArrayAsync(default(string));
            traktRecommendationMovies.Should().Throw<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_RecommendationMovieArrayJsonReader_ReadArray_From_Json_String_Empty()
        {
            var jsonReader = new ArrayJsonReader<ITraktRecommendationMovie>();
            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = await jsonReader.ReadArrayAsync(string.Empty);

namespace TraktNet.Objects.Get.Tests.Recommendations.Json.Writer
{
    ...
    {
        [Fact]
        public void Test_RecommendationMovieArrayJsonWriter_WriteArray_Array_Exceptions()
        {
        ...
        [Fact]
        public async Task Test_RecommendationMovieArrayJsonWriter_WriteArray_Array_Empty()
        {
            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = new List<TraktRecommendationMovie>();
            var traktJsonWriter = new ArrayJsonWriter<ITraktRecommendationMovie>();
            string json = await traktJsonWriter.WriteArrayAsync(traktRecommendationMovies);
            json.Should().Be("[]");
        }

        [Fact]
        public async Task Test_RecommendationMovieArrayJsonWriter_WriteArray_Array_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_RecommendationMovieArrayJsonWriter_WriteArray_Array_Complete()
        {
            IEnumerable<ITraktRecommendationMovie> traktRecommendationMovies = new List<ITraktRecommendationMovie>
            {
                new TraktRecommendationMovie

namespace TraktNet.Objects.Get.Tests.Syncs.Activities.Json.Reader
{
    ...
    public partial class SyncLastActivitiesObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_SyncLastActivitiesObjectJsonReader_ReadObject_From_JsonReader_Incomplete_14()
        {
            var traktJsonReader = new SyncLastActivitiesObjectJsonReader();
        ...
        [Fact]
        public void Test_SyncLastActivitiesObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new SyncLastActivitiesObjectJsonReader();

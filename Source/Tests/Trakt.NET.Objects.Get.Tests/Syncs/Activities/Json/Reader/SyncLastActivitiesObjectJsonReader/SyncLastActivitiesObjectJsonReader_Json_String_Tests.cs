namespace TraktNet.Objects.Get.Tests.Syncs.Activities.Json.Reader
{
    ...
    public partial class SyncLastActivitiesObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_SyncLastActivitiesObjectJsonReader_ReadObject_From_Json_String_Not_Valid()
        {
            var jsonReader = new SyncLastActivitiesObjectJsonReader();

            var lastActivities = await jsonReader.ReadObjectAsync(JSON_NOT_VALID);
        ...
        {
            var jsonReader = new SyncLastActivitiesObjectJsonReader();
            Func<Task<ITraktSyncLastActivities>> lastActivities = () => jsonReader.ReadObjectAsync(default(string));

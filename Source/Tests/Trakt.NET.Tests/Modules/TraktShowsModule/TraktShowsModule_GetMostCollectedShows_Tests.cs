namespace TraktNet.Tests.Modules.TraktShowsModule
{
    ...
    public partial class TraktShowsModule_Tests
    {
        ...
        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_NotFoundException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, HttpStatusCode.NotFound);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktNotFoundException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_AuthorizationException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, HttpStatusCode.Unauthorized);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktAuthorizationException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_BadRequestException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, HttpStatusCode.BadRequest);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktBadRequestException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ForbiddenException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, HttpStatusCode.Forbidden);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktForbiddenException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_MethodNotFoundException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, HttpStatusCode.MethodNotAllowed);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktMethodNotFoundException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ConflictException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, HttpStatusCode.Conflict);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktConflictException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ServerException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, HttpStatusCode.InternalServerError);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktServerException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_BadGatewayException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, HttpStatusCode.BadGateway);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktBadGatewayException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_PreconditionFailedException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, (HttpStatusCode)412);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktPreconditionFailedException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ValidationException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, (HttpStatusCode)422);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktValidationException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_RateLimitException()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, (HttpStatusCode)429);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktRateLimitException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ServerUnavailableException_503()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, (HttpStatusCode)503);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktServerUnavailableException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ServerUnavailableException_504()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, (HttpStatusCode)504);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktServerUnavailableException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ServerUnavailableException_520()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, (HttpStatusCode)520);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktServerUnavailableException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ServerUnavailableException_521()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, (HttpStatusCode)521);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktServerUnavailableException>();
        }

        [Fact]
        public void Test_TraktShowsModule_GetMostCollectedShows_Throws_ServerUnavailableException_522()
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_SHOWS_URI, (HttpStatusCode)522);
            Func<Task<TraktPagedResponse<ITraktMostPWCShow>>> act = () => client.Shows.GetMostCollectedShowsAsync();
            act.Should().Throw<TraktServerUnavailableException>();
        }
    }

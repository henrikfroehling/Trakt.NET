namespace TraktNet.Objects.Post.Tests.Syncs.Recommendations.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_SyncRecommendationsPostMovieObjectJsonReader_ReadObject_From_Stream_Complete()
        {
            var traktJsonReader = new SyncRecommendationsPostMovieObjectJsonReader();

            using var stream = JSON_COMPLETE.ToStream();
            ITraktSyncRecommendationsPostMovie traktSyncRecommendationsPostMovie = await traktJsonReader.ReadObjectAsync(stream);
        ...
        [Fact]
        public async Task Test_SyncRecommendationsPostMovieObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var traktJsonReader = new SyncRecommendationsPostMovieObjectJsonReader();
            Func<Task<ITraktSyncRecommendationsPostMovie>> traktSyncRecommendationsPostMovie = () => traktJsonReader.ReadObjectAsync(default(Stream));
            await traktSyncRecommendationsPostMovie.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_SyncRecommendationsPostMovieObjectJsonReader_ReadObject_From_Stream_Empty()
        {
            var traktJsonReader = new SyncRecommendationsPostMovieObjectJsonReader();

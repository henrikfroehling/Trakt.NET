namespace TraktNet.Objects.Post.Tests.Syncs.Recommendations.Json.Reader
{
    ...
    public partial class SyncRecommendationsPostObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_SyncRecommendationsPostObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new SyncRecommendationsPostObjectJsonReader();
            Func<Task<ITraktSyncRecommendationsPost>> traktSyncRecommendationsPost = () => traktJsonReader.ReadObjectAsync(default(JsonTextReader));
            await traktSyncRecommendationsPost.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_SyncRecommendationsPostObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new SyncRecommendationsPostObjectJsonReader();

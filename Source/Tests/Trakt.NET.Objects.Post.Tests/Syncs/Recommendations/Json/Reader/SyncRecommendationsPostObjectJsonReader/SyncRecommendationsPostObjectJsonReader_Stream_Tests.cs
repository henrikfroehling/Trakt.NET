namespace TraktNet.Objects.Post.Tests.Syncs.Recommendations.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_SyncRecommendationsPostObjectJsonReader_ReadObject_From_Stream_Complete()
        {
            var traktJsonReader = new SyncRecommendationsPostObjectJsonReader();

            using var stream = JSON_COMPLETE.ToStream();
            ITraktSyncRecommendationsPost traktSyncRecommendationsPost = await traktJsonReader.ReadObjectAsync(stream);
        ...
        [Fact]
        public async Task Test_SyncRecommendationsPostObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var traktJsonReader = new SyncRecommendationsPostObjectJsonReader();
            Func<Task<ITraktSyncRecommendationsPost>> traktSyncRecommendationsPost = () => traktJsonReader.ReadObjectAsync(default(Stream));
            await traktSyncRecommendationsPost.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_SyncRecommendationsPostObjectJsonReader_ReadObject_From_Stream_Empty()
        {
            var traktJsonReader = new SyncRecommendationsPostObjectJsonReader();

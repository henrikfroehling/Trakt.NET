namespace TraktNet.Objects.Post.Tests.Users.CustomListItems.Responses.Json.Reader
{
    ...
    public partial class UserCustomListItemsPostResponseNotFoundGroupObjectJsonReader_Tests
    {
        ...
        public async Task Test_UserCustomListItemsPostResponseNotFoundGroupObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            ...
            {
                var customListItemsPostResponseNotFoundGroup = await traktJsonReader.ReadObjectAsync(jsonReader);
        ...
        [Fact]
        public void Test_UserCustomListItemsPostResponseNotFoundGroupObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new UserCustomListItemsPostResponseNotFoundGroupObjectJsonReader();
            Func<Task<ITraktUserCustomListItemsPostResponseNotFoundGroup>> customListItemsPostResponseNotFoundGroup = () => traktJsonReader.ReadObjectAsync(default(JsonTextReader));

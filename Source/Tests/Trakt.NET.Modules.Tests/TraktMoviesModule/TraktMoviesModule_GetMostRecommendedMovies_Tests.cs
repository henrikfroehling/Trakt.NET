namespace TraktNet.Modules.Tests.TraktMoviesModule
{
    ...
    public partial class TraktMoviesModule_Tests
    {
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync();
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Filtered()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(null, null, FILTER);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_TimePeriod()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_TimePeriod_Filtered()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD, null, FILTER);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_ExtendedInfo()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(null, EXTENDED_INFO);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_ExtendedInfo_Filtered()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(null, EXTENDED_INFO, FILTER);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_Page()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(null, null, null, pagedParameters);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_Page_Filtered()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(null, null, FILTER, pagedParameters);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_TimePeriod_And_ExtendedInfo()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD, EXTENDED_INFO);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_TimePeriod_And_ExtendedInfo_Filtered()
        {
            ...
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD, EXTENDED_INFO, FILTER);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_TimePeriod_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD, null, null, pagedParameters);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_TimePeriod_And_Page_Filtered()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD, null, FILTER, pagedParameters);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_ExtendedInfo_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(null, EXTENDED_INFO, null, pagedParameters);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_With_ExtendedInfo_And_Page_Filtered()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(null, EXTENDED_INFO, FILTER, pagedParameters);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Complete()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE, LIMIT);
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD, EXTENDED_INFO, null, pagedParameters);
        ...
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Complete_Filtered()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE, LIMIT);
            TraktPagedResponse<ITraktMostFavoritedMovie> response = await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD, EXTENDED_INFO, FILTER, pagedParameters);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_RECOMMENDED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                MOST_RECOMMENDED_MOVIES_JSON, 2, LIMIT, 5, MOST_RECOMMENDED_ITEM_COUNT);

            var pagedParameters = new TraktPagedParameters(2, LIMIT);

            TraktPagedResponse<ITraktMostFavoritedMovie> response =
                await client.Movies.GetMostRecommendedMoviesAsync(TIME_PERIOD, EXTENDED_INFO, null, pagedParameters);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_RECOMMENDED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                MOST_RECOMMENDED_MOVIES_JSON, 2, LIMIT, 2, MOST_RECOMMENDED_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_RECOMMENDED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                MOST_RECOMMENDED_MOVIES_JSON, 1, LIMIT, 2, MOST_RECOMMENDED_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_RECOMMENDED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                MOST_RECOMMENDED_MOVIES_JSON, 1, LIMIT, 1, MOST_RECOMMENDED_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_RECOMMENDED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                MOST_RECOMMENDED_MOVIES_JSON, 2, LIMIT, 2, MOST_RECOMMENDED_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostRecommendedMovies_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_RECOMMENDED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                MOST_RECOMMENDED_MOVIES_JSON, 1, LIMIT, 2, MOST_RECOMMENDED_ITEM_COUNT);

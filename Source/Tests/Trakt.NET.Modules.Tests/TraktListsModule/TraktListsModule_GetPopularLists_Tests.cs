namespace TraktNet.Modules.Tests.TraktListsModule
{
    ...
    public partial class TraktListsModule_Tests
    {
        ...
        public async Task Test_TraktListsModule_GetPopularLists_With_Page()
        {
            ...
            TraktPagedResponse<ITraktPopularList> response = await client.Lists.GetPopularListsAsync(null, pagedParameters);
        ...
        public async Task Test_TraktListsModule_GetPopularLists_With_ExtendedInfo_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktPopularList> response = await client.Lists.GetPopularListsAsync(EXTENDED_INFO, pagedParameters);

namespace TraktNet.Modules.Tests.TraktUsersModule
{
    ...
    public partial class TraktUsersModule_Tests
    {
        ...
        public async Task Test_TraktUsersModule_DeleteCustomList_Throws_API_Exception(HttpStatusCode statusCode, Type exceptionType)
        {
            TraktClient client = TestUtility.GetOAuthMockClient(DELETE_CUSTOM_LIST_URI, statusCode);

            try
            {
                await client.Users.DeleteCustomListAsync(USERNAME, LIST_ID);
                Assert.False(true);
            }

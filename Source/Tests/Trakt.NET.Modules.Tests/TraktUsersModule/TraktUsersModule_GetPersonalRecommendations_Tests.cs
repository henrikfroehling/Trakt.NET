namespace TraktNet.Modules.Tests.TraktUsersModule
{
    ...
    public partial class TraktUsersModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktUsersModule_GetPersonalRecommendations_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_PERSONAL_RECOMMENDATIONS_URI}/{RECOMMENDATION_TYPE.UriName}/{RECOMMENDATION_SORT_ORDER.UriName}" +
                $"?extended={EXTENDED_INFO}&page=2&limit={RECOMMENDATIONS_LIMIT}",
                USER_RECOMMENDATIONS_JSON, 2, RECOMMENDATIONS_LIMIT, 5, RECOMMENDATIONS_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktUsersModule_GetPersonalRecommendations_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_PERSONAL_RECOMMENDATIONS_URI}/{RECOMMENDATION_TYPE.UriName}/{RECOMMENDATION_SORT_ORDER.UriName}" +
                $"?extended={EXTENDED_INFO}&page=2&limit={RECOMMENDATIONS_LIMIT}",
                USER_RECOMMENDATIONS_JSON, 2, RECOMMENDATIONS_LIMIT, 2, RECOMMENDATIONS_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktUsersModule_GetPersonalRecommendations_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_PERSONAL_RECOMMENDATIONS_URI}/{RECOMMENDATION_TYPE.UriName}/{RECOMMENDATION_SORT_ORDER.UriName}" +
                $"?extended={EXTENDED_INFO}&page=1&limit={RECOMMENDATIONS_LIMIT}",
                USER_RECOMMENDATIONS_JSON, 1, RECOMMENDATIONS_LIMIT, 2, RECOMMENDATIONS_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktUsersModule_GetPersonalRecommendations_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_PERSONAL_RECOMMENDATIONS_URI}/{RECOMMENDATION_TYPE.UriName}/{RECOMMENDATION_SORT_ORDER.UriName}" +
                $"?extended={EXTENDED_INFO}&page=1&limit={RECOMMENDATIONS_LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktUsersModule_GetPersonalRecommendations_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_PERSONAL_RECOMMENDATIONS_URI}/{RECOMMENDATION_TYPE.UriName}/{RECOMMENDATION_SORT_ORDER.UriName}" +
                $"?extended={EXTENDED_INFO}&page=2&limit={RECOMMENDATIONS_LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktUsersModule_GetPersonalRecommendations_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_PERSONAL_RECOMMENDATIONS_URI}/{RECOMMENDATION_TYPE.UriName}/{RECOMMENDATION_SORT_ORDER.UriName}" +
                $"?extended={EXTENDED_INFO}&page=1&limit={RECOMMENDATIONS_LIMIT}",

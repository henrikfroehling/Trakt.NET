namespace TraktApiSharp.Tests.Requests.Movies
{
    ...
    public class TraktMovieRelatedMoviesRequest_Tests
    {
        ...
        {
            typeof(TraktMovieRelatedMoviesRequest).IsSubclassOf(typeof(ATraktMovieRequest<TraktMovie>)).Should().BeTrue();
        }
        ...
        {
            typeof(TraktMovieRelatedMoviesRequest).GetInterfaces().Should().Contain(typeof(ITraktSupportsPagination));
        }

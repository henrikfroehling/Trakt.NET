namespace TraktApiSharp.Tests.Requests.Interfaces.Base
{
    ...
    public class IPostRequest_1_Tests
    {
        ...
        [Fact]
        public void Test_IPostRequest_1_Inherits_ITraktRequest_Interface()
        {
            typeof(IPostRequest<>).GetInterfaces().Should().Contain(typeof(ITraktRequest));
        }

        [Fact]
        public void Test_IPostRequest_1_Inherits_ITraktHasRequestBody_1_Interface()
        {

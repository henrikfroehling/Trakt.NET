namespace TraktApiSharp.Tests.Requests.Episodes
{
    ...
    public class TraktEpisodeSummaryRequest_Tests
    {
        ...
        {
            typeof(TraktEpisodeSummaryRequest).IsSubclassOf(typeof(ATraktEpisodeRequest<ITraktEpisode>)).Should().BeTrue();
        }
        
        [Fact]
        public void Test_TraktEpisodeSummaryRequest_Implements_ITraktSupportsExtendedInfo_Interface()
        {
            typeof(TraktEpisodeSummaryRequest).GetInterfaces().Should().Contain(typeof(ISupportsExtendedInfo));
        }

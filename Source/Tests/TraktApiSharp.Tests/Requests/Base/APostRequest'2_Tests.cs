namespace TraktApiSharp.Tests.Requests.Base
{
    ...
    public class APostRequest_2_Tests
    {
        ...
        [Fact]
        public void Test_APostRequest_2_Inherits_ATraktRequest_1()
        {
            typeof(APostRequest<int, float>).IsSubclassOf(typeof(ATraktRequest<int>)).Should().BeTrue();
        }

        [Fact]
        public void Test_APostRequest_2_Implements_ITraktPostRequest_2_Interface()
        {
            typeof(APostRequest<int, float>).GetInterfaces().Should().Contain(typeof(ITraktPostRequest<int, float>));
        }

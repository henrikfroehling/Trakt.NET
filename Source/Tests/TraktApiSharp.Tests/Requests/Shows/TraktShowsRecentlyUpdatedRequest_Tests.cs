namespace TraktApiSharp.Tests.Requests.Shows
{
    ...
    public class TraktShowsRecentlyUpdatedRequest_Tests
    {
        ...
        {
            typeof(TraktShowsRecentlyUpdatedRequest).IsSubclassOf(typeof(ATraktGetRequest<TraktRecentlyUpdatedShow>)).Should().BeTrue();
        }
        ...
        {
            var periodPropertyInfo = typeof(TraktShowsRecentlyUpdatedRequest)

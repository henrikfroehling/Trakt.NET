namespace TraktApiSharp.Tests.Requests.Syncs.OAuth
{
    ...
    public class TraktSyncCollectionRemoveRequest_Tests
    {
        ...
        {
            typeof(TraktSyncCollectionRemoveRequest).IsSubclassOf(typeof(ASyncPostRequest<ITraktSyncCollectionRemovePostResponse, TraktSyncCollectionPost>)).Should().BeTrue();
        }

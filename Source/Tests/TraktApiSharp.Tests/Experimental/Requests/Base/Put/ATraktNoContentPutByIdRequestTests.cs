namespace TraktApiSharp.Tests.Experimental.Requests.Base.Put
{
    ...
    public class ATraktNoContentPutByIdRequestTests
    {
        ...
        [TestMethod, TestCategory("Requests"), TestCategory("Base"), TestCategory("Put")]
        public void TestATraktNoContentPutByIdRequestImplementsITraktObjectRequestInterface()
        {
            typeof(ATraktNoContentPutByIdRequest<float>).GetInterfaces().Should().Contain(typeof(ITraktObjectRequest));
        }
    }
}

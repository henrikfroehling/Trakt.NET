namespace TraktApiSharp.Tests.Experimental.Requests.Base.Post
{
    ...
    public class ATraktPaginationPostByIdRequestTests
    {
        ...
        [TestMethod, TestCategory("Requests"), TestCategory("Base"), TestCategory("Post")]
        public void TestATraktPaginationPostByIdRequestImplementsITraktObjectRequestInterface()
        {
            typeof(ATraktPaginationPostByIdRequest<,>).GetInterfaces().Should().Contain(typeof(ITraktObjectRequest));
        }
    }
}

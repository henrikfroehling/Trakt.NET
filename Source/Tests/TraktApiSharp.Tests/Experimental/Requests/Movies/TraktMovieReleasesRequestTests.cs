namespace TraktApiSharp.Tests.Experimental.Requests.Movies
{
    ...
    public class TraktMovieReleasesRequestTests
    {
        ...
        [TestMethod, TestCategory("Requests"), TestCategory("Movies")]
        public void TestTraktMovieReleasesRequestHasValidUriTemplate()
        {
            var request = new TraktMovieReleasesRequest(null);
            request.UriTemplate.Should().Be("movies/{id}/releases");
        }

        [TestMethod, TestCategory("Requests"), TestCategory("Movies")]
        public void TestTraktMovieReleasesRequestImplementsITraktObjectRequestInterface()
        {
            typeof(TraktMovieReleasesRequest).GetInterfaces().Should().Contain(typeof(ITraktObjectRequest));
        }
    }
}

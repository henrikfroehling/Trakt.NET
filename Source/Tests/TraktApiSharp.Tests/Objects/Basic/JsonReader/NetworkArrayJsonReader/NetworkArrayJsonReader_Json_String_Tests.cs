namespace TraktApiSharp.Tests.Objects.Basic.JsonReader.NetworkArrayJsonReader
{
    ...
    public partial class NetworkArrayJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_NetworkArrayJsonReader_ReadObject_From_Json_String_Complete()
        {
            var jsonReader = new NetworkArrayJsonReader();
        ...
        [Fact]
        public async Task Test_NetworkArrayJsonReader_ReadObject_From_Json_String_Not_Valid()
        {
            var jsonReader = new NetworkArrayJsonReader();
        ...
        [Fact]
        public async Task Test_NetworkArrayJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new NetworkArrayJsonReader();
        ...
        [Fact]
        public async Task Test_NetworkArrayJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new NetworkArrayJsonReader();

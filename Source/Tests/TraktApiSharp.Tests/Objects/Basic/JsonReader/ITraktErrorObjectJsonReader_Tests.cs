namespace TraktApiSharp.Tests.Objects.Basic.JsonReader
{
    ...
    public class ITraktErrorObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_Json_String_Complete()
        {
        ...
        [Fact]
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new ITraktErrorObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new ITraktErrorObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new ITraktErrorObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new ITraktErrorObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new ITraktErrorObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new ITraktErrorObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new ITraktErrorObjectJsonReader();
        ...
        public async Task Test_ITraktErrorObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            ...
            var traktError = await jsonReader.ReadObjectAsync(default(JsonTextReader));
            traktError.Should().BeNull();
        }

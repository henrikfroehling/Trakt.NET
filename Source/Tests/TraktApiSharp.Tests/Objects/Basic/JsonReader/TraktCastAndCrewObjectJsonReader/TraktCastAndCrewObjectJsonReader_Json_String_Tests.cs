namespace TraktApiSharp.Tests.Objects.Basic.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktCastAndCrewObjectJsonReader_ReadObject_From_Json_String_Complete()
        {
            var jsonReader = new TraktCastAndCrewObjectJsonReader();

            var castAndCrew = await jsonReader.ReadObjectAsync(JSON_COMPLETE);
        ...
        [Fact]
        public async Task Test_TraktCastAndCrewObjectJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new TraktCastAndCrewObjectJsonReader();

            var castAndCrew = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_1);
        ...
        [Fact]
        public async Task Test_TraktCastAndCrewObjectJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new TraktCastAndCrewObjectJsonReader();

            var castAndCrew = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_2);
        ...
        [Fact]
        public async Task Test_TraktCastAndCrewObjectJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new TraktCastAndCrewObjectJsonReader();

            var castAndCrew = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_1);
        ...
        [Fact]
        public async Task Test_TraktCastAndCrewObjectJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new TraktCastAndCrewObjectJsonReader();

            var castAndCrew = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_2);
        ...
        [Fact]
        public async Task Test_TraktCastAndCrewObjectJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new TraktCastAndCrewObjectJsonReader();

            var castAndCrew = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_3);
        ...
        [Fact]
        public async Task Test_TraktCastAndCrewObjectJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new TraktCastAndCrewObjectJsonReader();

            var castAndCrew = await jsonReader.ReadObjectAsync(default(string));
            castAndCrew.Should().BeNull();
        }

        [Fact]
        public async Task Test_TraktCastAndCrewObjectJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new TraktCastAndCrewObjectJsonReader();

            var castAndCrew = await jsonReader.ReadObjectAsync(string.Empty);
            castAndCrew.Should().BeNull();
        }
    }
}

namespace TraktApiSharp.Tests.Objects.Get.Seasons.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Complete()
        {
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Incomplete_3()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Incomplete_4()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Incomplete_5()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Incomplete_6()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Incomplete_7()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Incomplete_8()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_4()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_5()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktSeasonIdsObjectJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new TraktSeasonIdsObjectJsonReader();

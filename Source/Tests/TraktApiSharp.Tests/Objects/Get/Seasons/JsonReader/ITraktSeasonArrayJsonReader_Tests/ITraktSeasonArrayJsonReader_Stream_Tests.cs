namespace TraktApiSharp.Tests.Objects.Get.Seasons.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_ITraktSeasonArrayJsonReader_ReadArray_From_Stream_Empty_Array()
        {
        ...
        [Fact]
        public async Task Test_ITraktSeasonArrayJsonReader_ReadArray_From_Stream_Minimal_Complete()
        {
            var traktJsonReader = new ITraktSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktSeasonArrayJsonReader_ReadArray_From_Stream_Full_Complete()
        {
            var traktJsonReader = new ITraktSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktSeasonArrayJsonReader_ReadArray_From_Stream_Null()
        {
            var traktJsonReader = new ITraktSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktSeasonArrayJsonReader_ReadArray_From_Stream_Empty()
        {
            var traktJsonReader = new ITraktSeasonArrayJsonReader();

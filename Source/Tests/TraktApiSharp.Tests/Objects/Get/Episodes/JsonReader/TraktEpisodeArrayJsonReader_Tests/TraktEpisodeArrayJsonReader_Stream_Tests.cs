namespace TraktApiSharp.Tests.Objects.Get.Episodes.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktEpisodeArrayJsonReader_ReadArray_From_Stream_Empty_Array()
        {
        ...
        [Fact]
        public async Task Test_TraktEpisodeArrayJsonReader_ReadArray_From_Stream_Minimal_Complete()
        {
            var traktJsonReader = new TraktEpisodeArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktEpisodeArrayJsonReader_ReadArray_From_Stream_Full_Complete()
        {
            var traktJsonReader = new TraktEpisodeArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktEpisodeArrayJsonReader_ReadArray_From_Stream_Null()
        {
            var traktJsonReader = new TraktEpisodeArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktEpisodeArrayJsonReader_ReadArray_From_Stream_Empty()
        {
            var traktJsonReader = new TraktEpisodeArrayJsonReader();

namespace TraktApiSharp.Tests.Objects.Shows.Seasons
{
    ...
    public class TraktSeasonsAllTests
    {
        ...
        {
            var jsonFile = TestUtility.ReadFileContents(@"Objects\Get\Shows\Seasons\All\Metadata\SeasonsAllMetadata.json");
        ...
        {
            var jsonFile = TestUtility.ReadFileContents(@"Objects\Get\Shows\Seasons\All\Metadata\SeasonsAllMetadataWithEpisodes.json");

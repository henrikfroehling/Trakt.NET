namespace TraktApiSharp.Tests.Objects.Get.Shows.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_ITraktTrendingShowObjectJsonReader_ReadObject_From_Stream_Complete()
        {
        ...
        [Fact]
        public async Task Test_ITraktTrendingShowObjectJsonReader_ReadObject_From_Stream_Incomplete_1()
        {
            var traktJsonReader = new ITraktTrendingShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktTrendingShowObjectJsonReader_ReadObject_From_Stream_Incomplete_2()
        {
            var traktJsonReader = new ITraktTrendingShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktTrendingShowObjectJsonReader_ReadObject_From_Stream_Not_Valid_1()
        {
            var traktJsonReader = new ITraktTrendingShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktTrendingShowObjectJsonReader_ReadObject_From_Stream_Not_Valid_2()
        {
            var traktJsonReader = new ITraktTrendingShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktTrendingShowObjectJsonReader_ReadObject_From_Stream_Not_Valid_3()
        {
            var traktJsonReader = new ITraktTrendingShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktTrendingShowObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var traktJsonReader = new ITraktTrendingShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktTrendingShowObjectJsonReader_ReadObject_From_Stream_Empty()
        {
            var traktJsonReader = new ITraktTrendingShowObjectJsonReader();

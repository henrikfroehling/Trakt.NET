namespace TraktApiSharp.Tests.Objects.Shows.Common
{
    ...
    public class TraktShowsMostWatchedTests
    {
        ...
        {
            var watchedShow = new TraktShowsMostWatchedItem();

            watchedShow.WatcherCount.Should().Be(0);
            watchedShow.PlayCount.Should().Be(0);
            watchedShow.CollectedCount.Should().Be(0);
            watchedShow.CollectorCount.Should().Be(0);
        ...
        public void TestTraktShowsMostWatchedReadFromJson()
        {
            ...
            var watchedShows = JsonConvert.DeserializeObject<IEnumerable<TraktShowsMostWatchedItem>>(jsonFile);

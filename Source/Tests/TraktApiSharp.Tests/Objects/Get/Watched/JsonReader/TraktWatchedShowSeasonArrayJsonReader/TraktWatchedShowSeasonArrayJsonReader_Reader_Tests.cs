namespace TraktApiSharp.Tests.Objects.Get.Watched.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Empty_Array()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Complete()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Null()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();

            var traktSeasonWatchedProgress = await traktJsonReader.ReadArrayAsync(default(JsonTextReader));
            traktSeasonWatchedProgress.Should().BeNull();
        }

        [Fact]
        public async Task Test_TraktWatchedShowSeasonArrayJsonReader_ReadArray_From_JsonReader_Empty()
        {
            var traktJsonReader = new TraktWatchedShowSeasonArrayJsonReader();

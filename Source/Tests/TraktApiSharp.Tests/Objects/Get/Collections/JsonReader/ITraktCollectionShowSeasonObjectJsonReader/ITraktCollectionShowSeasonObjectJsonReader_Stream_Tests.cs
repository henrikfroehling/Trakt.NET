namespace TraktApiSharp.Tests.Objects.Get.Collections.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_Stream_Complete()
        {
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_Stream_Incomplete_1()
        {
            var jsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_Stream_Incomplete_2()
        {
            var jsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_Stream_Not_Valid_1()
        {
            var jsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_Stream_Not_Valid_2()
        {
            var jsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_Stream_Not_Valid_3()
        {
            var jsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var jsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_Stream_Empty()
        {
            var jsonReader = new ITraktCollectionShowSeasonObjectJsonReader();

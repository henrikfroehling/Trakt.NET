namespace TraktApiSharp.Tests.Objects.Get.Collections.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            var traktJsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new ITraktCollectionShowSeasonObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ITraktCollectionShowSeasonObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new ITraktCollectionShowSeasonObjectJsonReader();

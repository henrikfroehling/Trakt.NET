namespace TraktApiSharp.Tests.Objects.Get.Collections.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Incomplete_3()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Incomplete_4()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Incomplete_5()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Incomplete_6()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_4()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktCollectionMovieObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new TraktCollectionMovieObjectJsonReader();

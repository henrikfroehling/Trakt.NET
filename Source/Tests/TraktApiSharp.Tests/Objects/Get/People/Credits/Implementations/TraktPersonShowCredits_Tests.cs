namespace TraktApiSharp.Tests.Objects.Get.People.Credits.Implementations
{
    ...
    {
        [Fact]
        public void Test_TraktPersonShowCredits_Implements_ITraktPersonShowCredits_Interface()
        {
            typeof(TraktPersonShowCredits).GetInterfaces().Should().Contain(typeof(ITraktPersonShowCredits));
        }
        ...
        public void Test_TraktPersonShowCredits_From_Minimal_Json()
        {
            ...
            creditsCast[0].Character.Should().Be("Jon Snow");
            ...
            creditsCast[1].Character.Should().Be("Tyrion");
        ...
        public void Test_TraktPersonShowCredits_From_Full_Json()
        {
            ...
            creditsCast[0].Show.Title.Should().Be("Game of Thrones");
            creditsCast[0].Show.Year.Should().Be(2011);
            creditsCast[0].Show.Airs.Should().NotBeNull();
            creditsCast[0].Show.Airs.Day.Should().Be("Sunday");
            creditsCast[0].Show.Airs.Time.Should().Be("21:00");
            creditsCast[0].Show.Airs.TimeZoneId.Should().Be("America/New_York");
            creditsCast[0].Show.AvailableTranslationLanguageCodes.Should().NotBeNull().And.HaveCount(4).And.Contain("en", "fr", "it", "de");
            creditsCast[0].Show.Ids.Should().NotBeNull();
            creditsCast[0].Show.Ids.Trakt.Should().Be(1390U);
            creditsCast[0].Show.Ids.Slug.Should().Be("game-of-thrones");
            creditsCast[0].Show.Ids.Tvdb.Should().Be(121361U);
            ...
            creditsCast[0].Show.Ids.Tmdb.Should().Be(1399U);
            creditsCast[0].Show.Ids.TvRage.Should().Be(24493U);
            creditsCast[0].Show.Genres.Should().NotBeNull().And.HaveCount(5).And.Contain("drama", "fantasy", "science-fiction", "action", "adventure");
            creditsCast[0].Show.Seasons.Should().BeNull();
            creditsCast[0].Show.Overview.Should().Be("Seven noble families fight for control of the mythical land of Westeros. Friction between the houses leads to full-scale war. All while a very ancient evil awakens in the farthest north. Amidst the war, a neglected military order of misfits, the Night's Watch, is all that stands between the realms of men and the icy horrors beyond.");
            creditsCast[0].Show.FirstAired.Should().Be(DateTime.Parse("2011-04-17T07:00:00Z").ToUniversalTime());
            creditsCast[0].Show.Runtime.Should().Be(60);
            creditsCast[0].Show.Certification.Should().Be("TV-MA");
            creditsCast[0].Show.Network.Should().Be("HBO");
            creditsCast[0].Show.CountryCode.Should().Be("us");
            creditsCast[0].Show.UpdatedAt.Should().Be(DateTime.Parse("2016-04-06T10:39:11Z").ToUniversalTime());
            creditsCast[0].Show.Trailer.Should().Be("http://youtube.com/watch?v=F9Bo89m2f6g");
            creditsCast[0].Show.Homepage.Should().Be("http://www.hbo.com/game-of-thrones");
            creditsCast[0].Show.Status.Should().Be(TraktShowStatus.ReturningSeries);
            creditsCast[0].Show.Rating.Should().Be(9.38327f);
            creditsCast[0].Show.Votes.Should().Be(44773);
            creditsCast[0].Show.LanguageCode.Should().Be("en");
            creditsCast[0].Show.AiredEpisodes.Should().Be(50);
            ...
            creditsCast[1].Show.Title.Should().Be("Game of Thrones");
            creditsCast[1].Show.Year.Should().Be(2011);
            creditsCast[1].Show.Airs.Should().NotBeNull();
            creditsCast[1].Show.Airs.Day.Should().Be("Sunday");
            creditsCast[1].Show.Airs.Time.Should().Be("21:00");
            creditsCast[1].Show.Airs.TimeZoneId.Should().Be("America/New_York");
            creditsCast[1].Show.AvailableTranslationLanguageCodes.Should().NotBeNull().And.HaveCount(4).And.Contain("en", "fr", "it", "de");
            creditsCast[1].Show.Ids.Should().NotBeNull();
            creditsCast[1].Show.Ids.Trakt.Should().Be(1390U);
            creditsCast[1].Show.Ids.Slug.Should().Be("game-of-thrones");
            creditsCast[1].Show.Ids.Tvdb.Should().Be(121361U);
            ...
            creditsCast[1].Show.Ids.Tmdb.Should().Be(1399U);
            creditsCast[1].Show.Ids.TvRage.Should().Be(24493U);
            creditsCast[1].Show.Genres.Should().NotBeNull().And.HaveCount(5).And.Contain("drama", "fantasy", "science-fiction", "action", "adventure");
            creditsCast[1].Show.Seasons.Should().BeNull();
            creditsCast[1].Show.Overview.Should().Be("Seven noble families fight for control of the mythical land of Westeros. Friction between the houses leads to full-scale war. All while a very ancient evil awakens in the farthest north. Amidst the war, a neglected military order of misfits, the Night's Watch, is all that stands between the realms of men and the icy horrors beyond.");
            creditsCast[1].Show.FirstAired.Should().Be(DateTime.Parse("2011-04-17T07:00:00Z").ToUniversalTime());
            creditsCast[1].Show.Runtime.Should().Be(60);
            creditsCast[1].Show.Certification.Should().Be("TV-MA");
            creditsCast[1].Show.Network.Should().Be("HBO");
            creditsCast[1].Show.CountryCode.Should().Be("us");
            creditsCast[1].Show.UpdatedAt.Should().Be(DateTime.Parse("2016-04-06T10:39:11Z").ToUniversalTime());
            creditsCast[1].Show.Trailer.Should().Be("http://youtube.com/watch?v=F9Bo89m2f6g");
            creditsCast[1].Show.Homepage.Should().Be("http://www.hbo.com/game-of-thrones");
            creditsCast[1].Show.Status.Should().Be(TraktShowStatus.ReturningSeries);
            creditsCast[1].Show.Rating.Should().Be(9.38327f);
            creditsCast[1].Show.Votes.Should().Be(44773);
            creditsCast[1].Show.LanguageCode.Should().Be("en");
            creditsCast[1].Show.AiredEpisodes.Should().Be(50);

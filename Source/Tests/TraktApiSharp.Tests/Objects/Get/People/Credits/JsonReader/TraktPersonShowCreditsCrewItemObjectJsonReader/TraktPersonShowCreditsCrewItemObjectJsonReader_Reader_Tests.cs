namespace TraktApiSharp.Tests.Objects.Get.People.Credits.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktPersonShowCreditsCrewItemObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            var traktJsonReader = new TraktPersonShowCreditsCrewItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonShowCreditsCrewItemObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new TraktPersonShowCreditsCrewItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonShowCreditsCrewItemObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new TraktPersonShowCreditsCrewItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonShowCreditsCrewItemObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new TraktPersonShowCreditsCrewItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonShowCreditsCrewItemObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new TraktPersonShowCreditsCrewItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonShowCreditsCrewItemObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new TraktPersonShowCreditsCrewItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonShowCreditsCrewItemObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new TraktPersonShowCreditsCrewItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonShowCreditsCrewItemObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new TraktPersonShowCreditsCrewItemObjectJsonReader();

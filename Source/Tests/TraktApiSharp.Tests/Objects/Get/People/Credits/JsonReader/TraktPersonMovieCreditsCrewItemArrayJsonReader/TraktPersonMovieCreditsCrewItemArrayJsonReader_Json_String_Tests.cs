namespace TraktApiSharp.Tests.Objects.Get.People.Credits.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadArray_From_Json_String_Empty_Array()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadObject_From_Json_String_Complete()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();
        ...
        [Fact]
        public async Task Test_TraktPersonMovieCreditsCrewItemArrayJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new TraktPersonMovieCreditsCrewItemArrayJsonReader();

namespace TraktApiSharp.Tests.Objects.Get.Users.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_Stream_Complete()
        {
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_Stream_Incomplete_1()
        {
            var jsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_Stream_Incomplete_2()
        {
            var jsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_Stream_Not_Valid_1()
        {
            var jsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_Stream_Not_Valid_2()
        {
            var jsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_Stream_Not_Valid_3()
        {
            var jsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var jsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_Stream_Empty()
        {
            var jsonReader = new TraktUserFollowerObjectJsonReader();

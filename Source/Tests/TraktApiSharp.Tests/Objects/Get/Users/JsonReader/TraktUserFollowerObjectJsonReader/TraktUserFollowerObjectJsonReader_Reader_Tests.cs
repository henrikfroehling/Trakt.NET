namespace TraktApiSharp.Tests.Objects.Get.Users.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            var traktJsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new TraktUserFollowerObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFollowerObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new TraktUserFollowerObjectJsonReader();

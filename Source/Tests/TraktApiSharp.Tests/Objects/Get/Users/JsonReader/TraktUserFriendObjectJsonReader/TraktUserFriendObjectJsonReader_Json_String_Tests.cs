namespace TraktApiSharp.Tests.Objects.Get.Users.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktUserFriendObjectJsonReader_ReadObject_From_Json_String_Complete()
        {
        ...
        [Fact]
        public async Task Test_TraktUserFriendObjectJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new TraktUserFriendObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFriendObjectJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new TraktUserFriendObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFriendObjectJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new TraktUserFriendObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFriendObjectJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new TraktUserFriendObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFriendObjectJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new TraktUserFriendObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserFriendObjectJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new TraktUserFriendObjectJsonReader();

            var userFriend = await jsonReader.ReadObjectAsync(default(string));
            userFriend.Should().BeNull();
        }

        [Fact]
        public async Task Test_TraktUserFriendObjectJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new TraktUserFriendObjectJsonReader();

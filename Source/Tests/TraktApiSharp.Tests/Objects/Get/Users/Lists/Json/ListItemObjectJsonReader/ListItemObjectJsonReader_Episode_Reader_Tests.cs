namespace TraktApiSharp.Tests.Objects.Get.Users.Lists.Json
{
    ...
    public partial class ListItemObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_ListItemObjectJsonReader_Episode_ReadObject_From_JsonReader_Incomplete_8()
        {
            var traktJsonReader = new ListItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ListItemObjectJsonReader_Episode_ReadObject_From_JsonReader_Incomplete_9()
        {
            var traktJsonReader = new ListItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ListItemObjectJsonReader_Episode_ReadObject_From_JsonReader_Incomplete_10()
        {
            var traktJsonReader = new ListItemObjectJsonReader();

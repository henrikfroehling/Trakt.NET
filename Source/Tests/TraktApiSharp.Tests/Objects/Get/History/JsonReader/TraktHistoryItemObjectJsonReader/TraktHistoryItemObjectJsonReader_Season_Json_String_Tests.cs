namespace TraktApiSharp.Tests.Objects.Get.History.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Complete()
        {
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_3()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_4()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_5()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_6()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_7()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_8()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_9()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Incomplete_10()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Not_Valid_4()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Not_Valid_5()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktHistoryItemObjectJsonReader_Season_ReadObject_From_Json_String_Not_Valid_6()
        {
            var jsonReader = new TraktHistoryItemObjectJsonReader();

namespace TraktApiSharp.Tests.Objects.Get.Movies.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktBoxOfficeMovieObjectJsonReader_ReadObject_From_Json_String_Complete()
        {
        ...
        [Fact]
        public async Task Test_TraktBoxOfficeMovieObjectJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new TraktBoxOfficeMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktBoxOfficeMovieObjectJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new TraktBoxOfficeMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktBoxOfficeMovieObjectJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new TraktBoxOfficeMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktBoxOfficeMovieObjectJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new TraktBoxOfficeMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktBoxOfficeMovieObjectJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new TraktBoxOfficeMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktBoxOfficeMovieObjectJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new TraktBoxOfficeMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktBoxOfficeMovieObjectJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new TraktBoxOfficeMovieObjectJsonReader();

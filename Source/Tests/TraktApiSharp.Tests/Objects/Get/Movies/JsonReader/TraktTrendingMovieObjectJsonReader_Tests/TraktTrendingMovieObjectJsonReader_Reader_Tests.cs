namespace TraktApiSharp.Tests.Objects.Get.Movies.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktTrendingMovieObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
        ...
        [Fact]
        public async Task Test_TraktTrendingMovieObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new TraktTrendingMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktTrendingMovieObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new TraktTrendingMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktTrendingMovieObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new TraktTrendingMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktTrendingMovieObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new TraktTrendingMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktTrendingMovieObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new TraktTrendingMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktTrendingMovieObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new TraktTrendingMovieObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktTrendingMovieObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new TraktTrendingMovieObjectJsonReader();

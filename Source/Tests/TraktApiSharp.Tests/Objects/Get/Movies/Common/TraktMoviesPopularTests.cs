namespace TraktApiSharp.Tests.Objects.Movies.Common
{
    ...
    public class TraktMoviesPopularTests
    {
        ...
        {
            var popularShow = new TraktPopularMovie();
        ...
        {
            var jsonFile = TestUtility.ReadFileContents(@"Objects\Get\Movies\Common\MoviesPopular.json");

            jsonFile.Should().NotBeNullOrEmpty();

            var popularMovies = JsonConvert.DeserializeObject<IEnumerable<TraktPopularMovie>>(jsonFile);

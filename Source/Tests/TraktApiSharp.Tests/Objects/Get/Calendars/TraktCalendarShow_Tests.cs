namespace TraktApiSharp.Tests.Objects.Get.Calendars
{
    ...
    public class TraktCalendarShow_Tests
    {
        ...
        public void Test_TraktCalendarShow_From_Minimal_Json()
        {
            ...
            calendarShow.Episode.EpisodeNumber.Should().Be(1);
            calendarShow.Episode.EpisodeTitle.Should().Be("Winter Is Coming");
            calendarShow.Episode.EpisodeIds.Should().NotBeNull();
            calendarShow.Episode.EpisodeIds.Trakt.Should().Be(73640U);
            calendarShow.Episode.EpisodeIds.Tvdb.Should().Be(3254641U);
            calendarShow.Episode.EpisodeIds.Imdb.Should().Be("tt1480055");
            calendarShow.Episode.EpisodeIds.Tmdb.Should().Be(63056U);
            calendarShow.Episode.EpisodeIds.TvRage.Should().Be(1065008299U);
            calendarShow.Episode.AbsoluteEpisodeNumber.Should().NotHaveValue();
            calendarShow.Episode.EpisodeOverview.Should().BeNullOrEmpty();
            calendarShow.Episode.EpisodeRuntime.Should().NotHaveValue();
            calendarShow.Episode.EpisodeRating.Should().NotHaveValue();
            calendarShow.Episode.EpisodeVotes.Should().NotHaveValue();
            calendarShow.Episode.EpisodeAiredFirstAt.Should().NotHaveValue();
            calendarShow.Episode.EpisodeUpdatedAt.Should().NotHaveValue();
            calendarShow.Episode.AvailableEpisodeTranslationLanguageCodes.Should().BeNull();
            calendarShow.Episode.EpisodeTranslations.Should().BeNull();
        ...
        public void Test_TraktCalendarShow_From_Full_Json()
        {
            ...
            calendarShow.Episode.EpisodeIds.Tmdb.Should().Be(63056U);
            calendarShow.Episode.EpisodeIds.TvRage.Should().Be(1065008299U);
            calendarShow.Episode.AbsoluteEpisodeNumber.Should().Be(50);
            calendarShow.Episode.EpisodeOverview.Should().Be("Ned Stark, Lord of Winterfell learns that his mentor, Jon Arryn, has died and that King Robert is on his way north to offer Ned Arryn’s position as the King’s Hand. Across the Narrow Sea in Pentos, Viserys Targaryen plans to wed his sister Daenerys to the nomadic Dothraki warrior leader, Khal Drogo to forge an alliance to take the throne.");
            calendarShow.Episode.EpisodeRuntime.Should().Be(55);
            calendarShow.Episode.EpisodeRating.Should().Be(9.0f);
            calendarShow.Episode.EpisodeVotes.Should().Be(111);
            calendarShow.Episode.EpisodeAiredFirstAt.Should().Be(DateTime.Parse("2011-04-18T01:00:00.000Z").ToUniversalTime());
            calendarShow.Episode.EpisodeUpdatedAt.Should().Be(DateTime.Parse("2014-08-29T23:16:39.000Z").ToUniversalTime());
            calendarShow.Episode.AvailableEpisodeTranslationLanguageCodes.Should().NotBeNull().And.HaveCount(2).And.Contain("en", "es");
            calendarShow.Episode.EpisodeTranslations.Should().NotBeNull().And.HaveCount(2);

            var translations = calendarShow.Episode.EpisodeTranslations.ToArray();

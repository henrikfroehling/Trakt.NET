namespace TraktApiSharp.Tests.Objects.Shows
{
    ...
    public class TraktShowRatingTests
    {
        ...
        public void TestTraktShowRatingDefaultConstructor()
        {
            ...
            showRating.Rating.Should().NotHaveValue();
            showRating.Votes.Should().NotHaveValue();
        ...
        {
            var jsonFile = TestUtility.ReadFileContents(@"Shows\ShowRatings.json");
            ...
            showRating.Rating.Should().Be(9.38231m);

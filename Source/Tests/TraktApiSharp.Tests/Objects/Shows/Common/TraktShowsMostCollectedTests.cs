namespace TraktApiSharp.Tests.Objects.Shows.Common
{
    ...
    using System.Linq;
    using TraktApiSharp.Objects.Shows.Common;
    using Utils;
    ...
    public class TraktShowsMostCollectedTests
    {
        ...
        {
            var collectedShow = new TraktShowsMostCollectedItem();
        ...
        {
            var jsonFile = TestUtility.ReadFileContents(@"Shows\Common\ShowsMostCollected.json");

            jsonFile.Should().NotBeNullOrEmpty();

            var collectedShows = JsonConvert.DeserializeObject<IEnumerable<TraktShowsMostCollectedItem>>(jsonFile);

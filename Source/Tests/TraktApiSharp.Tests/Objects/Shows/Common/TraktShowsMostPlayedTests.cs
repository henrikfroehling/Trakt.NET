namespace TraktApiSharp.Tests.Objects.Shows.Common
{
    ...
    public class TraktShowsMostPlayedTests
    {
        ...
        {
            var jsonFile = TestUtility.ReadFileContents(@"Shows\Common\ShowsMostPlayed.json");

            jsonFile.Should().NotBeNullOrEmpty();

            var playedShows = JsonConvert.DeserializeObject<IEnumerable<TraktShowsMostPlayedItem>>(jsonFile);

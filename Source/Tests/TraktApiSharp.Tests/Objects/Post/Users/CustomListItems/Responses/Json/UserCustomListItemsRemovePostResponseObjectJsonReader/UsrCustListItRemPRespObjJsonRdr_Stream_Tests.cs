namespace TraktApiSharp.Tests.Objects.Post.Users.CustomListItems.Responses.Json
{
    ...
    {
        [Fact]
        public async Task Test_UserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Complete()
        {
        ...
        [Fact]
        public async Task Test_UserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_1()
        {
            var jsonReader = new UserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_2()
        {
            var jsonReader = new UserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Not_Valid_2()
        {
            var jsonReader = new UserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var jsonReader = new UserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Empty()
        {
            var jsonReader = new UserCustomListItemsRemovePostResponseObjectJsonReader();

namespace TraktApiSharp.Tests.Objects.Post.Users.CustomListItems.Responses.JsonReader
{
    ...
    {
        [Fact]
        public async Task Test_TraktUserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Complete()
        {
        ...
        [Fact]
        public async Task Test_TraktUserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_1()
        {
            var jsonReader = new TraktUserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_2()
        {
            var jsonReader = new TraktUserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Not_Valid_1()
        {
            var jsonReader = new TraktUserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Not_Valid_2()
        {
            var jsonReader = new TraktUserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Not_Valid_3()
        {
            var jsonReader = new TraktUserCustomListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_TraktUserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var jsonReader = new TraktUserCustomListItemsRemovePostResponseObjectJsonReader();

            var customListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(default(Stream));
            customListItemsRemovePostResponse.Should().BeNull();
        }

        [Fact]
        public async Task Test_TraktUserCustomListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Stream_Empty()
        {
            var jsonReader = new TraktUserCustomListItemsRemovePostResponseObjectJsonReader();

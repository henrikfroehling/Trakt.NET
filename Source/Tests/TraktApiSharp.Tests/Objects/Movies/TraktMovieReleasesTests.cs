namespace TraktApiSharp.Tests.Objects.Movies
{
    ...
    public class TraktMovieReleasesTests
    {
        ...
        {
            var jsonFile = TestUtility.ReadFileContents(@"Movies\MovieReleases.json");
            ...
            releasesArray[0].Country.Should().NotBeNull();
            ...
            releasesArray[1].Country.Should().NotBeNull();
            ...
            releasesArray[2].Country.Should().NotBeNull();

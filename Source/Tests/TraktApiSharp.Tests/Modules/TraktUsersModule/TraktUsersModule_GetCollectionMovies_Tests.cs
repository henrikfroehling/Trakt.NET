namespace TraktApiSharp.Tests.Modules.TraktUsersModule
{
    ...
    {
        [Fact]
        public void Test_TraktUsersModule_GetCollectionMovies()
        {
            const string username = "sean";

            TestUtility.SetupMockResponseWithoutOAuth($"users/{username}/collection/movies", COLLECTION_MOVIES_JSON);
        ...
        [Fact]
        public void Test_TraktUsersModule_GetCollectionMoviesWithOAuthEnforced()
        {
            const string username = "sean";

            TestUtility.SetupMockResponseWithOAuth($"users/{username}/collection/movies", COLLECTION_MOVIES_JSON);
        ...
        [Fact]
        public void Test_TraktUsersModule_GetCollectionMoviesWithExtendedInfo()
        {
            const string username = "sean";
            var extendedInfo = new TraktExtendedInfo { Full = true };

            TestUtility.SetupMockResponseWithoutOAuth($"users/{username}/collection/movies?extended={extendedInfo}",
        ...
        [Fact]
        public void Test_TraktUsersModule_GetCollectionMoviesExceptions()
        {
            const string username = "sean";
        ...
        [Fact]
        public void Test_TraktUsersModule_GetCollectionMoviesArgumentExceptions()
        {
            Func<Task<TraktListResponse<ITraktCollectionMovie>>> act =

namespace TraktApiSharp.Tests.Modules.TraktUsersModule
{
    ...
    {
        [Fact]
        public void Test_TraktUsersModule_UnlikeList()
        {
        ...
        [Fact]
        public void Test_TraktUsersModule_UnlikeListExceptions()
        {
            const string username = "sean";
            const string listId = "55";
        ...
        [Fact]
        public void Test_TraktUsersModule_UnlikeListArgumentExceptions()
        {
            const string username = "sean";
            const string listId = "55";

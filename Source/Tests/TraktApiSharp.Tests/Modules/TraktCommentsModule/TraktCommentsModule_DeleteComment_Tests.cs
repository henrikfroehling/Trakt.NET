namespace TraktApiSharp.Tests.Modules.TraktCommentsModule
{
    ...
    {
        [Fact]
        public void Test_TraktCommentsModule_DeleteComment()
        {
        ...
        [Fact]
        public void Test_TraktCommentsModule_DeleteCommentExceptions()
        {
            const uint commentId = 190U;
        ...
        [Fact]
        public void Test_TraktCommentsModule_DeleteCommentArgumentExceptions()
        {
            const uint commentId = 190U;

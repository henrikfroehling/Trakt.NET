namespace TraktApiSharp.Tests.Modules.TraktEpisodesModule
{
    ...
    {
        [Fact]
        public void Test_TraktEpisodesModule_GetEpisodeSingleTranslation()
        {
        ...
        [Fact]
        public void Test_TraktEpisodesModule_GetEpisodeSingleTranslationExceptions()
        {
            const string showId = "1390";
            const uint seasonNr = 1U;
            const uint episodeNr = 1U;
        ...
        [Fact]
        public void Test_TraktEpisodesModule_GetEpisodeSingleTranslationArgumentExceptions()
        {
            const string showId = "1390";

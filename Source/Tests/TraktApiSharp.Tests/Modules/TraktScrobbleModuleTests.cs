namespace TraktApiSharp.Tests.Modules
{
    ...
    public class TraktScrobbleModuleTests
    {
        ...
        public void TestTraktScrobbleModuleStartEpisodeArgumentExceptions()
        {
            ...
            act = async () => await TestUtility.MOCK_TEST_CLIENT.Scrobble.StartEpisodeAsync(episode, -0.01f);
            act.ShouldThrow<ArgumentException>();

            act = async () => await TestUtility.MOCK_TEST_CLIENT.Scrobble.StartEpisodeAsync(episode, 100.01f);
            act.ShouldThrow<ArgumentException>();
            ...
            act = async () => await TestUtility.MOCK_TEST_CLIENT.Scrobble.StartEpisodeAsync(episode, -0.01f, show);
            act.ShouldThrow<ArgumentException>();

            act = async () => await TestUtility.MOCK_TEST_CLIENT.Scrobble.StartEpisodeAsync(episode, 100.01f, show);
            act.ShouldThrow<ArgumentException>();
        ...
        public void TestTraktScrobbleModulePauseEpisodeArgumentExceptions()
        {
            ...
            act = async () => await TestUtility.MOCK_TEST_CLIENT.Scrobble.PauseEpisodeAsync(episode, -0.01f);
            act.ShouldThrow<ArgumentException>();

            act = async () => await TestUtility.MOCK_TEST_CLIENT.Scrobble.PauseEpisodeAsync(episode, 100.01f);
            act.ShouldThrow<ArgumentException>();
            ...
            act = async () => await TestUtility.MOCK_TEST_CLIENT.Scrobble.PauseEpisodeAsync(episode, -0.01f, show);
            act.ShouldThrow<ArgumentException>();

            act = async () => await TestUtility.MOCK_TEST_CLIENT.Scrobble.PauseEpisodeAsync(episode, 100.01f, show);
            act.ShouldThrow<ArgumentException>();

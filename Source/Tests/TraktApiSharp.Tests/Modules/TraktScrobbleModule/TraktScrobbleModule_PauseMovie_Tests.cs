namespace TraktApiSharp.Tests.Modules.TraktScrobbleModule
{
    ...
    public partial class TraktScrobbleModule_Tests
    {
        ...
        public async Task Test_TraktScrobbleModule_PauseMovie()
        {
            ...
            string postJson = await TestUtility.SerializeObject<ITraktMovieScrobblePost>(moviePauseScrobblePost);
            postJson.Should().NotBeNullOrEmpty();

            TestUtility.SetupMockResponseWithOAuth("scrobble/pause", postJson, MOVIE_PAUSE_SCROBBLE_POST_RESPONSE_JSON);
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseMovieWithAppVersion()
        {
            var movie = new TraktMovie
            {
                Title = "Guardians of the Galaxy",
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseMovieWithAppDate()
        {
            var movie = new TraktMovie
            {
                Title = "Guardians of the Galaxy",
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseMovieWithAppVersionAndAppDate()
        {
            var movie = new TraktMovie
            {
                Title = "Guardians of the Galaxy",
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseMovieComplete()
        {
            var movie = new TraktMovie
            {
                Title = "Guardians of the Galaxy",
        ...
        [Fact]
        public void Test_TraktScrobbleModule_PauseMovieExceptions()
        {
            var movie = new TraktMovie
            {
                Title = "Guardians of the Galaxy",
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseMovieArgumentExceptions()
        {
            var movie = new TraktMovie
            {
                Title = "Guardians of the Galaxy",

namespace TraktApiSharp.Tests.Modules.TraktScrobbleModule
{
    ...
    public partial class TraktScrobbleModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_StopEpisodeWithAppVersion()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_StopEpisodeWithAppDate()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_StopEpisodeWithAppVersionAndAppDate()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_StopEpisodeComplete()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public void Test_TraktScrobbleModule_StopEpisodeExceptions()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_StopEpisodeArgumentExceptions()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 0,

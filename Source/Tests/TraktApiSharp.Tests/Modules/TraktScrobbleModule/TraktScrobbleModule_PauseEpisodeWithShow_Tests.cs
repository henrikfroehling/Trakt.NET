namespace TraktApiSharp.Tests.Modules.TraktScrobbleModule
{
    ...
    public partial class TraktScrobbleModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseEpisodeWithShowAndAppVersion()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseEpisodeWithShowAndAppDate()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseEpisodeWithShowAndAppVersionAndAppDate()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public async Task Test_TraktScrobbleModule_PauseEpisodeWithShowComplete()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,
        ...
        [Fact]
        public void Test_TraktScrobbleModule_PauseEpisodeWithShowExceptions()
        {
            var episode = new TraktEpisode
            {
                SeasonNumber = 1,

namespace TraktApiSharp.Tests.Modules.TraktShowsModule
{
    ...
    {
        [Fact]
        public void Test_TraktShowsModule_GetShowLastEpisode()
        {
            const string showId = "1390";

            TestUtility.SetupMockResponseWithoutOAuth($"shows/{showId}/last_episode", SHOW_EPISODE_JSON);
        ...
        [Fact]
        public void Test_TraktShowsModule_GetShowLastEpisodeWithExtendedInfo()
        {
            const string showId = "1390";
            var extendedInfo = new TraktExtendedInfo { Full = true };

            TestUtility.SetupMockResponseWithoutOAuth($"shows/{showId}/last_episode?extended={extendedInfo}", SHOW_EPISODE_JSON);
        ...
        [Fact]
        public void Test_TraktShowsModule_GetShowLastEpisodeExceptions()
        {
            const string showId = "1390";
        ...
        [Fact]
        public void Test_TraktShowsModule_GetShowLastEpisodeArgumentExceptions()
        {
            const string showId = "1390";

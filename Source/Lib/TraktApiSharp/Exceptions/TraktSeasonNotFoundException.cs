namespace TraktNet.Exceptions
{
    ...
    public class TraktSeasonNotFoundException : TraktShowNotFoundException
    {
        ...
        public TraktSeasonNotFoundException(string showId, uint season) : this("Season Not Found - method exists, but no record found", showId, season) { }
        ...
        /// <param name="showId">The Trakt-Id or -Slug of the season's show.</param>
        /// <param name="season">The season number of the season, which was not found.</param>
        public TraktSeasonNotFoundException(string message, string showId, uint season) : base(message, showId)
        {
            Season = season;
        }

namespace TraktApiSharp.Requests.Calendars
{
    ...
    internal abstract class ATraktCalendarRequest<TResponseContentType> : ATraktGetRequest<TResponseContentType>, ITraktSupportsExtendedInfo, ITraktSupportsFilter
    {

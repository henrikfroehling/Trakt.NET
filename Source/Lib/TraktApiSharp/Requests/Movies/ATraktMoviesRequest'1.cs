namespace TraktApiSharp.Requests.Movies
{
    ...
    internal abstract class ATraktMoviesRequest<TResponseContentType> : AGetRequest<TResponseContentType>, ISupportsExtendedInfo, ISupportsFilter, ITraktSupportsPagination
    {

namespace TraktApiSharp.Requests.Params
{
    ...
    /// Supported by <see cref="Modules.TraktSearchModule.GetTextQueryResultsAsync(Enums.TraktSearchResultType, string, TraktSearchFilter, TraktExtendedOption, int?, int?)" />.<para />

namespace TraktApiSharp.Requests.Parameters
{
    ...
    /// Supported by <see cref="TraktSearchModule.GetTextQueryResultsAsync(TraktSearchResultType, string, TraktSearchField, TraktSearchFilter, TraktExtendedInfo, int?, int?)" />.<para />

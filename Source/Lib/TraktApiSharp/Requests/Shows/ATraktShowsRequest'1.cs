namespace TraktApiSharp.Requests.Shows
{
    ...
    internal abstract class ATraktShowsRequest<TResponseContentType> : AGetRequest<TResponseContentType>, ISupportsExtendedInfo, ISupportsFilter, ITraktSupportsPagination
    {

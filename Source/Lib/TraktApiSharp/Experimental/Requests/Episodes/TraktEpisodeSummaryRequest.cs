namespace TraktApiSharp.Experimental.Requests.Episodes
{
    ...
    internal sealed class TraktEpisodeSummaryRequest : ITraktSupportsExtendedInfo, ITraktValidatable
    {
        internal TraktEpisodeSummaryRequest(TraktClient client) { }
        ...
        public string UriTemplate => "shows/{id}/seasons/{season}/episodes/{episode}{?extended}";
    }
}

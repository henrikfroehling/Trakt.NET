namespace TraktApiSharp.Objects.Basic.Json.Writer
{
    ...
    internal class CommentObjectJsonWriter : AObjectJsonWriter<ITraktComment>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktComment obj, CancellationToken cancellationToken = default)
        {
            if (jsonWriter == null)

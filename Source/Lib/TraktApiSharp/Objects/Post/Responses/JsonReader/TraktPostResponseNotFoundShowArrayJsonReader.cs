namespace TraktApiSharp.Objects.Post.Responses.JsonReader
{
    ...
    internal class TraktPostResponseNotFoundShowArrayJsonReader : ITraktArrayJsonReader<ITraktPostResponseNotFoundShow>
    {
        ...
        public async Task<IEnumerable<ITraktPostResponseNotFoundShow>> ReadArrayAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var postResponseNotFoundShowObjectReader = new TraktPostResponseNotFoundShowObjectJsonReader();

namespace TraktApiSharp.Objects.Post.Responses.JsonReader
{
    ...
    internal class TraktPostResponseNotFoundEpisodeArrayJsonReader : ITraktArrayJsonReader<ITraktPostResponseNotFoundEpisode>
    {
        ...
        public async Task<IEnumerable<ITraktPostResponseNotFoundEpisode>> ReadArrayAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var postResponseNotFoundEpisodeObjectReader = new TraktPostResponseNotFoundEpisodeObjectJsonReader();

namespace TraktApiSharp.Objects.Post.Responses.JsonReader
{
    ...
    internal class TraktPostResponseNotFoundPersonObjectJsonReader : ITraktObjectJsonReader<ITraktPostResponseNotFoundPerson>
    {
        ...
        public async Task<ITraktPostResponseNotFoundPerson> ReadObjectAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var personIdsReader = new TraktPersonIdsObjectJsonReader();

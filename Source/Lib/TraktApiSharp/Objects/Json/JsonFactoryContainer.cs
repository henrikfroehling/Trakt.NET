...
{
    using Basic;
    using Basic.Json.Factories.Reader;
    using Get.Calendars;
    using Get.Calendars.Json.Factories.Reader;
    using Get.Collections;
    using Get.Collections.Json.Factories.Reader;
    using Get.Episodes;
    using Get.Episodes.Json.Factories.Reader;
    using Get.History;
    using Get.History.Json.Factories.Reader;
    using Get.Movies;
    using Get.Movies.Json.Factories.Reader;
    using Get.People;
    using Get.People.Credits;
    using Get.People.Credits.Json.Factories.Reader;
    using Get.People.Json.Factories.Reader;
    using Get.Ratings;
    using Get.Ratings.Json.Factories.Reader;
    using Get.Seasons;
    using Get.Seasons.Json.Factories.Reader;
    using Get.Shows;
    using Get.Shows.Json.Factories.Reader;
    using Get.Syncs.Activities;
    using Get.Syncs.Activities.Json.Factories.Reader;
    using Get.Syncs.Playback;
    using Get.Syncs.Playback.Json.Factories.Reader;
    using Get.Users;
    using Get.Users.Json.Factories.Reader;
    using Get.Users.Lists;
    using Get.Users.Lists.Json.Factories.Reader;
    using Get.Users.Statistics;
    using Get.Users.Statistics.Json.Factories.Reader;
    using Get.Watched;
    using Get.Watched.Json.Factories.Reader;
    using Get.Watchlist;
    using Get.Watchlist.Json.Factories.Reader;
    using Post.Checkins.Responses;
    using Post.Checkins.Responses.Json.Factories.Reader;
    using Post.Comments.Responses;
    using Post.Comments.Responses.Json.Factories.Reader;
    using Post.Responses;
    using Post.Responses.Json.Factories.Reader;
    using Post.Scrobbles.Responses;
    using Post.Scrobbles.Responses.Json.Factories.Reader;
    using Post.Syncs.Collection.Responses;
    using Post.Syncs.Collection.Responses.Json.Factories.Reader;
    using Post.Syncs.History.Responses;
    using Post.Syncs.History.Responses.Json.Factories.Reader;
    using Post.Syncs.Ratings.Responses;
    using Post.Syncs.Ratings.Responses.Json.Factories.Reader;
    using Post.Syncs.Responses;
    using Post.Syncs.Responses.Json.Factories.Reader;
    using Post.Syncs.Watchlist.Responses;
    using Post.Syncs.Watchlist.Responses.Json.Factories.Reader;
    using Post.Users.CustomListItems.Responses;
    using Post.Users.CustomListItems.Responses.Json.Factories.Reader;
    using Post.Users.Responses;
    using Post.Users.Responses.Json.Factories.Reader;
    using System;
    ...
    internal static class JsonFactoryContainer
    {
        ...
        static JsonFactoryContainer()
        {
            ...
            s_readerFactories.Add(typeof(ITraktCertification), new CertificationJsonReaderFactory());
            s_readerFactories.Add(typeof(ITraktCertifications), new CertificationsJsonReaderFactory());
            ...
            s_readerFactories.Add(typeof(ITraktSyncCollectionRemovePostResponse), new SyncCollectionRemovePostResponseJsonReaderFactory());
            ...
            s_readerFactories.Add(typeof(ITraktUserFollowUserPostResponse), new UserFollowUserPostResponseJsonReaderFactory());

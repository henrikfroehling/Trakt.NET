namespace TraktApiSharp.Objects.Get.Syncs.Activities.Json.Writer
{
    ...
    internal class SyncMoviesLastActivitiesObjectJsonWriter : AObjectJsonWriter<ITraktSyncMoviesLastActivities>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncMoviesLastActivities obj, CancellationToken cancellationToken = default)
        {
            ...
            {
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_MOVIES_LAST_ACTIVITIES_PROPERTY_NAME_WATCHED_AT, cancellationToken).ConfigureAwait(false);
            ...
            {
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_MOVIES_LAST_ACTIVITIES_PROPERTY_NAME_COLLECTED_AT, cancellationToken).ConfigureAwait(false);
            ...
            {
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_MOVIES_LAST_ACTIVITIES_PROPERTY_NAME_RATED_AT, cancellationToken).ConfigureAwait(false);
            ...
            {
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_MOVIES_LAST_ACTIVITIES_PROPERTY_NAME_WATCHLISTED_AT, cancellationToken).ConfigureAwait(false);
            ...
            {
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_MOVIES_LAST_ACTIVITIES_PROPERTY_NAME_COMMENTED_AT, cancellationToken).ConfigureAwait(false);
            ...
            {
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_MOVIES_LAST_ACTIVITIES_PROPERTY_NAME_PAUSED_AT, cancellationToken).ConfigureAwait(false);
            ...
            {
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_MOVIES_LAST_ACTIVITIES_PROPERTY_NAME_HIDDEN_AT, cancellationToken).ConfigureAwait(false);

namespace TraktApiSharp.Objects.Get.Movies.JsonReader
{
    ...
    internal class TraktTrendingMovieArrayJsonReader : ITraktArrayJsonReader<ITraktTrendingMovie>
    {
        ...
        public async Task<IEnumerable<ITraktTrendingMovie>> ReadArrayAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var trendingMovieReader = new TraktTrendingMovieObjectJsonReader();

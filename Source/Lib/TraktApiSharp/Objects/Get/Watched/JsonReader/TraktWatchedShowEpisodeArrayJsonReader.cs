namespace TraktApiSharp.Objects.Get.Watched.JsonReader
{
    ...
    internal class TraktWatchedShowEpisodeArrayJsonReader : ITraktArrayJsonReader<ITraktWatchedShowEpisode>
    {
        ...
        public async Task<IEnumerable<ITraktWatchedShowEpisode>> ReadArrayAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var watchedShowEpisodeObjectReader = new TraktWatchedShowEpisodeObjectJsonReader();

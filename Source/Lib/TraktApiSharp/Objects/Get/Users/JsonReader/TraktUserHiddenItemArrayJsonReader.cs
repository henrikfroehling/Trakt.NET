namespace TraktApiSharp.Objects.Get.Users.JsonReader
{
    ...
    internal class TraktUserHiddenItemArrayJsonReader : ITraktArrayJsonReader<ITraktUserHiddenItem>
    {
        ...
        public async Task<IEnumerable<ITraktUserHiddenItem>> ReadArrayAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var userHiddenItemReader = new TraktUserHiddenItemObjectJsonReader();

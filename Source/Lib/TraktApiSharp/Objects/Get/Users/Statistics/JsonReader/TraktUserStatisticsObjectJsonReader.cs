namespace TraktApiSharp.Objects.Get.Users.Statistics.JsonReader
{
    ...
    internal class TraktUserStatisticsObjectJsonReader : ITraktObjectJsonReader<ITraktUserStatistics>
    {
        ...
        public async Task<ITraktUserStatistics> ReadObjectAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var moviesStatisticsReader = new TraktUserMoviesStatisticsObjectJsonReader();
                ...
                var episodesStatisticsReader = new TraktUserEpisodesStatisticsObjectJsonReader();

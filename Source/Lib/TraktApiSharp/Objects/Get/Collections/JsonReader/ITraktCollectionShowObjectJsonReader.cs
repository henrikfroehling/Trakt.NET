namespace TraktApiSharp.Objects.Get.Collections.JsonReader
{
    ...
    internal class ITraktCollectionShowObjectJsonReader : ITraktObjectJsonReader<ITraktCollectionShow>
    {
        ...
        public async Task<ITraktCollectionShow> ReadObjectAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (await jsonReader.ReadAsync(cancellationToken) && jsonReader.TokenType == JsonToken.StartObject)
            {
                ...
                var showSeasonsArrayReader = new ITraktCollectionShowSeasonArrayJsonReader();

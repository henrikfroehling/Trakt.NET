namespace TraktApiSharp.Objects.Get.People.Credits.JsonReader
{
    ...
    internal class TraktPersonMovieCreditsObjectJsonReader : ITraktObjectJsonReader<ITraktPersonMovieCredits>
    {
        ...
        public async Task<ITraktPersonMovieCredits> ReadObjectAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var movieCreditsCastReader = new TraktPersonMovieCreditsCastItemArrayJsonReader();
                var movieCreditsCrewReader = new TraktPersonMovieCreditsCrewObjectJsonReader();

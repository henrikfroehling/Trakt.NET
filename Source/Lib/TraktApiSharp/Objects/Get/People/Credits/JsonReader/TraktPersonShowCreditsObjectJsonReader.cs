namespace TraktApiSharp.Objects.Get.People.Credits.JsonReader
{
    ...
    internal class TraktPersonShowCreditsObjectJsonReader : ITraktObjectJsonReader<ITraktPersonShowCredits>
    {
        ...
        public async Task<ITraktPersonShowCredits> ReadObjectAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var showCreditsCastReader = new TraktPersonShowCreditsCastItemArrayJsonReader();
                var showCreditsCrewReader = new TraktPersonShowCreditsCrewObjectJsonReader();

namespace TraktApiSharp.Objects.Get.People.Credits.Json.Factories
{
    ...
    internal class PersonShowCreditsCrewJsonReaderFactory : IJsonIOFactory<ITraktPersonShowCreditsCrew>
    {
        ...
        public IObjectJsonReader<ITraktPersonShowCreditsCrew> CreateObjectWriter()
        {
            throw new NotImplementedException();
        }

        public IArrayJsonReader<ITraktPersonShowCreditsCrew> CreateArrayWriter()
        {
            throw new NotImplementedException();
        }
    }

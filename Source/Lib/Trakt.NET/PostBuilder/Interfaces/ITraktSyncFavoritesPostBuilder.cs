namespace TraktNet.PostBuilder
{
    ...
    public interface ITraktSyncFavoritesPostBuilder
    {
        ...
        /// <returns>Returns a reference to itself. See also <seealso cref="ITraktSyncFavoritesPostBuilder"/>.</returns>
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="movie"/> is null.</exception>
        ITraktSyncFavoritesPostBuilder WithMovie(ITraktMovie movie);
        ...
        ITraktSyncFavoritesPostBuilder WithMovie(ITraktMovieIds movieIds);
        ...
        ITraktSyncFavoritesPostBuilder WithMovieWithNotes(ITraktMovie movie, string notes);
        ...
        ITraktSyncFavoritesPostBuilder WithMovieWithNotes(MovieWithNotes movieWithNotes);
        ...
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="notes"/> is null.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown, if the given <paramref name="notes"/> has more than 255 characters.</exception>
        ITraktSyncFavoritesPostBuilder WithMovieWithNotes(ITraktMovieIds movieIds, string notes);
        ...
        ITraktSyncFavoritesPostBuilder WithMovieWithNotes(MovieIdsWithNotes movieIdsWithNotes);
        ...
        ITraktSyncFavoritesPostBuilder WithMovies(IEnumerable<ITraktMovie> movies);
        ...
        /// <returns>Returns a reference to itself. See also <seealso cref="ITraktSyncFavoritesPostBuilder"/>.</returns>
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="movieIds"/> is null.</exception>
        ITraktSyncFavoritesPostBuilder WithMovies(IEnumerable<ITraktMovieIds> movieIds);
        ...
        /// </exception>
        ITraktSyncFavoritesPostBuilder WithMoviesWithNotes(IEnumerable<MovieWithNotes> moviesWithNotes);
        ...
        /// </exception>
        ITraktSyncFavoritesPostBuilder WithMoviesWithNotes(IEnumerable<MovieIdsWithNotes> movieIdsWithNotes);
        ...
        ITraktSyncFavoritesPostBuilder WithShow(ITraktShow show);
        ...
        ITraktSyncFavoritesPostBuilder WithShow(ITraktShowIds showIds);
        ...
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="notes"/> is null.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown, if the given <paramref name="notes"/> has more than 255 characters.</exception>
        ITraktSyncFavoritesPostBuilder WithShowWithNotes(ITraktShow show, string notes);
        ...
        ITraktSyncFavoritesPostBuilder WithShowWithNotes(ShowWithNotes showWithNotes);
        ...
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="notes"/> is null.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown, if the given <paramref name="notes"/> has more than 255 characters.</exception>
        ITraktSyncFavoritesPostBuilder WithShowWithNotes(ITraktShowIds showIds, string notes);
        ...
        ITraktSyncFavoritesPostBuilder WithShowWithNotes(ShowIdsWithNotes showIdsWithNotes);
        ...
        ITraktSyncFavoritesPostBuilder WithShows(IEnumerable<ITraktShow> shows);
        ...
        /// <returns>Returns a reference to itself. See also <seealso cref="ITraktSyncFavoritesPostBuilder"/>.</returns>
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="showIds"/> is null.</exception>
        ITraktSyncFavoritesPostBuilder WithShows(IEnumerable<ITraktShowIds> showIds);
        ...
        /// </exception>
        ITraktSyncFavoritesPostBuilder WithShowsWithNotes(IEnumerable<ShowWithNotes> showsWithNotes);
        ...
        /// </exception>
        ITraktSyncFavoritesPostBuilder WithShowsWithNotes(IEnumerable<ShowIdsWithNotes> showIdsWithNotes);

        /// <summary>Creates a new <see cref="ITraktSyncFavoritesPost" /> instance with the added movies and shows.</summary>
        /// <returns>A new <see cref="ITraktSyncFavoritesPost" /> instance with the added movies and shows.</returns>
        ITraktSyncFavoritesPost Build();
    }
}

namespace TraktNet.PostBuilder
{
    ...
    public interface ITraktSyncFavoritesRemovePostBuilder
    {
        ...
        /// <returns>Returns a reference to itself. See also <seealso cref="ITraktSyncFavoritesRemovePostBuilder"/>.</returns>
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="movie"/> is null.</exception>
        ITraktSyncFavoritesRemovePostBuilder WithMovie(ITraktMovie movie);
        ...
        ITraktSyncFavoritesRemovePostBuilder WithMovie(ITraktMovieIds movieIds);
        ...
        ITraktSyncFavoritesRemovePostBuilder WithMovies(IEnumerable<ITraktMovie> movies);
        ...
        /// <returns>Returns a reference to itself. See also <seealso cref="ITraktSyncFavoritesRemovePostBuilder"/>.</returns>
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="movieIds"/> is null.</exception>
        ITraktSyncFavoritesRemovePostBuilder WithMovies(IEnumerable<ITraktMovieIds> movieIds);
        ...
        ITraktSyncFavoritesRemovePostBuilder WithShow(ITraktShow show);
        ...
        ITraktSyncFavoritesRemovePostBuilder WithShow(ITraktShowIds showIds);
        ...
        ITraktSyncFavoritesRemovePostBuilder WithShows(IEnumerable<ITraktShow> shows);
        ...
        /// <returns>Returns a reference to itself. See also <seealso cref="ITraktSyncFavoritesRemovePostBuilder"/>.</returns>
        /// <exception cref="ArgumentNullException">Thrown, if the given <paramref name="showIds"/> is null.</exception>
        ITraktSyncFavoritesRemovePostBuilder WithShows(IEnumerable<ITraktShowIds> showIds);

        /// <summary>Creates a new <see cref="ITraktSyncFavoritesRemovePost" /> instance with the added movies and shows.</summary>
        /// <returns>A new <see cref="ITraktSyncFavoritesRemovePost" /> instance with the added movies and shows.</returns>
        ITraktSyncFavoritesRemovePost Build();
    }
}

namespace TraktNet.PostBuilder
{
    ...
    internal sealed class EpisodeScrobblePostBuilder : AScrobblePostBuilder<ITraktEpisodeScrobblePostBuilder, ITraktEpisodeScrobblePost>, ITraktEpisodeScrobblePostBuilder
    {
        ...
        public ITraktEpisodeScrobblePostBuilder WithEpisode(ITraktEpisodeIds episodeIds)
        {
            if (episodeIds == null)
        ...
        public override ITraktEpisodeScrobblePost Build()
        {
            ...
            switch (_state)
            {
                ...
                case State.None:
                default:
                    throw new TraktPostValidationException("Empty scrobble post. No episode value set.");
            }

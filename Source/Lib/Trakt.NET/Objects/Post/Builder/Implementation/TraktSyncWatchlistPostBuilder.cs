namespace TraktNet.Objects.Post.Builder.Implementation
{
    ...
    public class TraktSyncWatchlistPostBuilder : ITraktSyncWatchlistPostBuilder
    {
        ...
        internal TraktSyncWatchlistPostBuilder()
        {
            ...
            _showsWithSeasons = new TraktPostBuilderShowAddedSeasons<ITraktSyncWatchlistPostBuilder, ITraktSyncWatchlistPost>();
            _showsWithSeasonsCollection = new TraktPostBuilderShowAddedSeasonsCollection<ITraktSyncWatchlistPostBuilder, ITraktSyncWatchlistPost, PostSeasons>();
        }

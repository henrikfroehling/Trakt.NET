namespace TraktNet.Objects.Post.Syncs.Recommendations.Json.Writer
{
    ...
    internal class SyncRecommendationsPostShowObjectJsonWriter : AObjectJsonWriter<ITraktSyncRecommendationsPostShow>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncRecommendationsPostShow obj, CancellationToken cancellationToken = default)
        {

        ...
        public override async Task<ITraktSyncCollectionPostShowEpisode> ReadObjectAsync(JsonTextReader jsonReader, CancellationToken cancellationToken = default)
        {
            ...
            if (await jsonReader.ReadAsync(cancellationToken) && jsonReader.TokenType == JsonToken.StartObject)
            {
                ...
                while (await jsonReader.ReadAsync(cancellationToken) && jsonReader.TokenType == JsonToken.PropertyName)
                {
                    ...
                    switch (propertyName)
                    {
                        case JsonProperties.SYNC_COLLECTION_POST_SHOW_EPISODE_PROPERTY_NAME_NUMBER:
                            {
                        ...
                        case JsonProperties.SYNC_COLLECTION_POST_SHOW_EPISODE_PROPERTY_NAME_COLLECTED_AT:
                            {

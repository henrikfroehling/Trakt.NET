namespace TraktNet.Objects.Post.Syncs.Favorites.Responses.Json.Writer
{
    ...
    internal class SyncFavoritesRemovePostResponseObjectJsonWriter : AObjectJsonWriter<ITraktSyncFavoritesRemovePostResponse>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncFavoritesRemovePostResponse obj, CancellationToken cancellationToken = default)
        {

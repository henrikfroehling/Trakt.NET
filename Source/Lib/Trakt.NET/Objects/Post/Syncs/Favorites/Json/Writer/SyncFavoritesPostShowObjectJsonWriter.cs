namespace TraktNet.Objects.Post.Syncs.Favorites.Json.Writer
{
    ...
    internal class SyncFavoritesPostShowObjectJsonWriter : AObjectJsonWriter<ITraktSyncFavoritesPostShow>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncFavoritesPostShow obj, CancellationToken cancellationToken = default)
        {

namespace TraktNet.Objects.Post.Syncs.Favorites.Json.Writer
{
    ...
    internal class SyncFavoritesPostMovieObjectJsonWriter : AObjectJsonWriter<ITraktSyncFavoritesPostMovie>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncFavoritesPostMovie obj, CancellationToken cancellationToken = default)
        {

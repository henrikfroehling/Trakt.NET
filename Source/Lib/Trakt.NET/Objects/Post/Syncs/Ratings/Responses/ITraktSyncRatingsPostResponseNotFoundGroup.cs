namespace TraktNet.Objects.Post.Syncs.Ratings.Responses
{
    ...
    public interface ITraktSyncRatingsPostResponseNotFoundGroup
    {
        ...
        /// <para>Nullable</para>
        /// </summary>
        IList<ITraktSyncRatingsPostResponseNotFoundEpisode> Episodes { get; set; }
    }
}

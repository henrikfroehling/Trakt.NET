namespace TraktNet.Objects.Post.Users.PersonalListItems.Responses.Json.Writer
{
    ...
    internal class UserPersonalListItemsPostResponseNotFoundGroupObjectJsonWriter : AObjectJsonWriter<ITraktUserPersonalListItemsPostResponseNotFoundGroup>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktUserPersonalListItemsPostResponseNotFoundGroup obj, CancellationToken cancellationToken = default)
        {

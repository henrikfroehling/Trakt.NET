namespace TraktNet.Objects.Get.Users.Json.Writer
{
    ...
    internal class UserRecommendationsLimitsObjectJsonWriter : AObjectJsonWriter<ITraktUserRecommendationsLimits>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktUserRecommendationsLimits obj, CancellationToken cancellationToken = default)
        {

namespace TraktNet.Objects.Get.Syncs.Activities.Json.Writer
{
    ...
    internal class SyncSavedFiltersLastActivitiesObjectJsonWriter : AObjectJsonWriter<ITraktSyncSavedFiltersLastActivities>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncSavedFiltersLastActivities obj, CancellationToken cancellationToken = default)
        {

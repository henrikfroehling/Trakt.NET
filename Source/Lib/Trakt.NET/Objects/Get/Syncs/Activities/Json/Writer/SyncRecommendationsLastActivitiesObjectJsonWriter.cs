namespace TraktNet.Objects.Get.Syncs.Activities.Json.Writer
{
    ...
    internal class SyncRecommendationsLastActivitiesObjectJsonWriter : AObjectJsonWriter<ITraktSyncRecommendationsLastActivities>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncRecommendationsLastActivities obj, CancellationToken cancellationToken = default)
        {

namespace TraktNet.Objects.Get.Syncs.Activities.Json.Writer
{
    ...
    internal class SyncCollaborationsLastActivitiesObjectJsonWriter : AObjectJsonWriter<ITraktSyncCollaborationsLastActivities>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncCollaborationsLastActivities obj, CancellationToken cancellationToken = default)
        {

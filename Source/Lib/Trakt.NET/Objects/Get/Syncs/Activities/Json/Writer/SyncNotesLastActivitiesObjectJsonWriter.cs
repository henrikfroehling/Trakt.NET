namespace TraktNet.Objects.Get.Syncs.Activities.Json.Writer
{
    ...
    internal class SyncNotesLastActivitiesObjectJsonWriter : AObjectJsonWriter<ITraktSyncNotesLastActivities>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncNotesLastActivities obj, CancellationToken cancellationToken = default)
        {

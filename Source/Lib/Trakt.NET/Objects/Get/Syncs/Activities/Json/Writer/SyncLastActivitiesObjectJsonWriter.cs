namespace TraktNet.Objects.Get.Syncs.Activities.Json.Writer
{
    ...
    internal class SyncLastActivitiesObjectJsonWriter : AObjectJsonWriter<ITraktSyncLastActivities>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktSyncLastActivities obj, CancellationToken cancellationToken = default)
        {
            ...
            if (obj.All.HasValue)
            {
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_LAST_ACTIVITIES_PROPERTY_NAME_ALL, cancellationToken).ConfigureAwait(false);
            ...
            if (obj.Movies != null)
            {
                ...
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_LAST_ACTIVITIES_PROPERTY_NAME_MOVIES, cancellationToken).ConfigureAwait(false);
            ...
            if (obj.Shows != null)
            {
                ...
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_LAST_ACTIVITIES_PROPERTY_NAME_SHOWS, cancellationToken).ConfigureAwait(false);
            ...
            if (obj.Seasons != null)
            {
                ...
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_LAST_ACTIVITIES_PROPERTY_NAME_SEASONS, cancellationToken).ConfigureAwait(false);
            ...
            if (obj.Episodes != null)
            {
                ...
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_LAST_ACTIVITIES_PROPERTY_NAME_EPISODES, cancellationToken).ConfigureAwait(false);
            ...
            if (obj.Comments != null)
            {
                ...
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_LAST_ACTIVITIES_PROPERTY_NAME_COMMENTS, cancellationToken).ConfigureAwait(false);
            ...
            if (obj.Lists != null)
            {
                ...
                await jsonWriter.WritePropertyNameAsync(JsonProperties.SYNC_LAST_ACTIVITIES_PROPERTY_NAME_LISTS, cancellationToken).ConfigureAwait(false);

namespace TraktNet.Requests.Users.OAuth
{
    ...
    internal sealed class UserWatchlistCommentsRequest : AGetRequest<ITraktComment>, IHasUsername, ISupportsPagination
    {
        ...
        public override string UriTemplate => "users/{username}/watchlist/comments{/sort}{?page,limit}";
